...
// Create a schema to specify the structure of the contact to appear in the form.
    ...
    <Container className="py-3">
      <Row className="justify-content-center">
        <Col xs={10}>
          ...
          <AutoForm ref={ref => { fRef = ref; }} schema={bridge} onSubmit={contact => submit(contact, fRef)}>
            <Card>
              <Card.Body>
                <TextField name="note" />
